...
contract PresaleNew is ReentrancyGuard {
    ...
    event PresaleCreated(address owner, address presaleContractAddress);
    event UserDepsitedSuccess(address buyerAddress, uint256 buyValue);
    event UserWithdrawSuccess(uint256 buyerAddress);
    event UserWithdrawTokensSuccess(uint256 withdrawAmount);
