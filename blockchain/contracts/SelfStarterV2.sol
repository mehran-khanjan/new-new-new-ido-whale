...
contract SelfStarterV2 is Ownable {
    ...
    struct Pool {
        ...
        // for example use should have min 250(minHolderBalance) token of POLS(onlyHolderToken)
        // uint256 minHolderBalance;
        uint256 startTime;
        uint256 timespan;
        // the programmer wants to take the IDO at least for 1 Day (min timespan is 1 day)
        bool enabled;
        bool finished;
    }
